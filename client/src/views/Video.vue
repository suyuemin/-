<template>
    <div class="video">
        ...
        <el-dialog title="浏览视频" :visible.sync="videoIsShow" width="800px">
...
export default {
    ...
    data() {
        return {
            fileList: [],
            videoList: [],
            iframe_url: '<iframe src="//player.bilibili.com/player.html?aid=837839066&bvid=BV1Tg4y1z7FH&cid=181579481&page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>"',
            dialogVisible: false,
            title: "",
            isEdit: false,
            updateId: 0,
